...
class funBatalha():
    ...
    def atualizaVida(self):
        ...
        self.textoTeste = IntVar()
        self.textoTeste.set(self.vidaT)
        print(self.textoTeste)
        print(self.vida)

        self.lb_txt1 = Label(self.cima, wraplength=self.win_width, textvariable=self.vida, bg="black", font=("Centurial Gothic", 12, 'bold'), fg="green")
...
class Batalha(funBatalha):
    ...
    def frameCima(self):
        ...
        self.textoTeste3 = StringVar()
        self.textoTeste3.set(self.vidaT)

        self.lb_txt11 = Label(self.cima,wraplength=self.win_width,textvariable=self.textoTeste3, bg="black", font=("Centurial Gothic", 12, 'bold'), fg="green")
        self.lb_txt11.place(relx=0.14, rely=0.01)

        self.lb_txt22 = Label(self.cima,wraplength=self.win_width, text="Vida Inimigo: ", bg="black", font=("Centurial Gothic", 12, 'bold'), fg="red")
        self.lb_txt22.place(relx=0.01, rely=0.25)

        self.textoTeste4 = StringVar()
        self.textoTeste4.set(self.vidaV)

        self.lb_txt3 = Label(self.cima,wraplength=self.win_width,textvariable=self.textoTeste4, bg="black", font=("Centurial Gothic", 12, 'bold'), fg="red")
        self.lb_txt3.place(relx=0.3, rely=0.26)
...
class App(Funcoes):
    ...
    def eIsso(self):
        ...
        self.bt_novo2 = Button(self.frameCima, text="Esquivar!", bd=3, bg="black", fg="red", font=("Century Gothic", 9, 'bold'), command=Batalha)
    ...
    def avancar(self):
        ...
        self.bt_novo2 = Button(self.frameCima, text="Contra-atacar", bd=3, bg="black", fg="red", font=("Century Gothic", 9, 'bold'), command=Batalha)
        self.bt_novo2.place(relx=0.35, rely=0.63, relwidth=0.3, relheight=0.25)
    ...
    def queIsso (self):
        ...
        self.bt_novo2 = Button(self.frameCima, text="Defesa", bd=3, bg="black", fg="red", font=("Century Gothic", 9, 'bold'), command=Batalha)
        self.bt_novo2.place(relx=0.35, rely=0.63, relwidth=0.3, relheight=0.25)
    ...
    def correr(self):
        ...
        self.bt_novo2 = Button(self.frameCima, text="Cadê?", bd=3, bg="black", fg="red", font=("Century Gothic", 9, 'bold'), command=Batalha)
